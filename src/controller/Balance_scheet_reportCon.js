...
function joinTables(
  ...
  console.log("tbl_company_branch8888888888888888888888888888888888");
  ...
  // console.log("leftJoinsResult join------------------- ");
  //  console.log(leftJoinsResult);
  ...
  // console.log("length befor filte7777777777777777777777777777777777777777777777777777777777777777777777777777r");
    ...
    openbalance == "y"
      ? (final["Amount"] = tbl_gl_balance_mst
          ...
          .reduce((sum, glb) => {
            ...
            // voucherdata.filter(e => e && e.GL_account !== null && e.GL_account !== undefined && e.GL_account === final.gl_id)
            // voucherdata.filter(e => e.GL_account = final.gl_id)
          }, 0))
      : (final["Amount"] = voucherdata
          .filter(
            (e) =>
              e &&
              e.GL_account !== null &&
              e.GL_account !== undefined &&
              e.GL_account === final.gl_id
          )
          .reduce((sum, vl) => {
            // Sum the balance, using 0 if op_bal or op_bal_cr is null (or undefined)
...
module.exports = {
  ...
  list: async (req, res) => {
    try {
      ...
      // console.log(new Date(tbl_financial_year_mst[0].start_date).toDateString());
      // console.log(includeOpBal);
      //console.log(tbl_voucher_ledger.length);
      //console.log(tbl_tb_group_mst.length);
      // let result = await innerJoinData(tbl_voucher_ledger, tbl_general_ledger_mst, tbl_tb_group_mst, tbl_balance_sheet_group_mst)
      // console.log(result);
      //     // return
      // let result_temp = result.filter(e => e.balance_sheet_group_id == 3 || e.balance_sheet_group_id == 4)
      // let total = 0;
      ...
      // Filtering out null values and objects without the balance_sheet_group_id property
      let result_temp = result.filter(
        (e) =>
          e &&
          typeof e.balance_sheet_group_id !== "undefined" &&
          (e.balance_sheet_group_id === 3 || e.balance_sheet_group_id === 4)
      );
      ...
      // console.log('Balance Sheet Group MST:', tbl_balance_sheet_group_mst);
      // console.log('TB Group MST:', tbl_tb_group_mst);
      // console.log('tbl_general_ledger_mst:', tbl_general_ledger_mst);
      // console.log('TB Group MSTtbl_company_mst:', tbl_company_mst);
      // console.log('TB Group MST:', tbl_company_branch);

      // ... log other data sets

      result.forEach((item) => {
        // Check if the item is not null and if GL_account is either undefined or null
        if (
          item &&
          (item.GL_account === null || item.GL_account === undefined)
        ) {
          // Set GL_account to 0 if it's null or undefined
          item.GL_account = 0;
        }
      });
      console.log(result);
      console.log(
        "resultresultresultresultresultresultresultresultresultresultresultresultresultresultresultresultresultresult..........................."
      );
      ...
      //data.someArrayOrObject.GL_account = 0;
      ...
      if (req.body.p_b === "P") {
        ...
        console.log("profitLossRow2222222222222222222.....................");
        console.log(profitLossRow);
        data.push(profitLossRow);
      }
      data = data.filter((row) => row["Amount"] !== 0);

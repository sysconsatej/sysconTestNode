...
module.exports = {
  ...
  spBlProfitability: async (req, res) => {
    try {
      const { recordId, clientId } = req.body;
      const query = `blProfitability`;
      const parameters = {
        recordId: recordId,
        clientId: clientId,
      };
  ...
  spJobProfitability: async (req, res) => {
    try {
      const { recordId, clientId } = req.body;
      const query = `jobProfitability`;
      const parameters = {
        recordId: recordId,
        clientId: clientId,
      };
  ...
  spCroprint: async (req, res) => {
    try {
      const { recordId } = req.body;
      const query = `croPrintDynamic`;
      const parameters = {
        id: recordId,
      };
      let data = await executeStoredProcedure(query, parameters);
